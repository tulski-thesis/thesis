...
Do konfiguracji DNS platformy tulski zastosowano usługi Cloudflare, dodając pięć rekordów A (admin, api, monitoring, registry, store), wszystkie kierujące na publiczny adres IP Load Balancera.
