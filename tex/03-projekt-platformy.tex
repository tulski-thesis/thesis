...
\todo{Nie za dużo screenshotów? Pozmiejszać je?}
...
Wykorzystano pakiet \mintinline{text}{bitnamicharts/postgresql}. Polecenie instalacyjne:
...
Zawartość pliku \mintinline{text}{db/values.yaml}:
\begin{figure}[H]
